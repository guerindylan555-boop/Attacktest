...
echo ====================================================================================================
echo NEW ACCOUNT TOKEN CAPTURE - WORKING VERSION
echo ====================================================================================================
echo.
echo This script captures tokens from your NEW account using the proven working method.
echo.
echo INSTRUCTIONS:
echo  1. Wait for hooks to install
echo  2. App will auto-launch
echo  3. Log in with your NEW account
echo  4. UNLOCK and LOCK a scooter
echo  5. Watch for "[UNLOCK]" and "[LOCK]" messages with Bearer tokens
echo  6. Token will be automatically saved to LATEST_TOKEN.txt
...
py capture_new_account_working.py
