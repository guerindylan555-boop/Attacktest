...
echo ====================================================================================================
echo [+] ADMIN TEST AFTER FRESH LOGIN
echo ====================================================================================================
echo [!] This script will capture a fresh token and immediately test admin endpoints.
echo [!] Theory: Admin scope might work with a fresh login session.
echo ====================================================================================================
echo.
echo INSTRUCTIONS:
...
echo  5. Watch for immediate admin endpoint testing
echo  6. Check results in ADMIN_TEST_RESULTS.json
...
echo [5/5] Starting fresh login admin test...
echo ====================================================================================================
echo FRESH LOGIN ADMIN TEST STARTING - APP WILL AUTO-LAUNCH
echo ====================================================================================================
echo.

set ADB_PATH=%ADB_CMD%
py test_admin_after_fresh_login.py
if %errorlevel% neq 0 (
...
echo.
echo [+] Fresh login admin test complete!
echo [OK] Check ADMIN_TEST_RESULTS.json for results
echo [OK] Check FRESH_TOKEN.txt for the captured token
echo.
pause
