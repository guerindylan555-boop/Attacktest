...
echo ====================================================================================================
echo WORKING FINAL CAPTURE - Using Discovered Coroutine Classes
echo ====================================================================================================
echo.
echo This script uses the real coroutine classes discovered through automatic analysis
echo.
echo INSTRUCTIONS:
echo  1. Wait for hooks to install
echo  2. App will auto-launch
echo  3. UNLOCK or LOCK a scooter
echo  4. Watch for "[UNLOCK]" and "[LOCK]" messages with Bearer tokens
...
echo [5/5] Starting working final capture...
echo ====================================================================================================
echo CAPTURE STARTING - APP WILL AUTO-LAUNCH
echo ====================================================================================================
echo.

py capture_working_final.py
